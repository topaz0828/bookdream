...
var Body = function (_React$Component) {
	...
	_createClass(Body, [{
		...
		key: 'makeContentsRow',
		value: function makeContentsRow(col, data, contentsCount) {
		...
		key: 'makeContentsCard',
		value: function makeContentsCard(data) {
...
var _Contents = __webpack_require__(29);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ id: 'mainView' },
					_react2.default.createElement(_Contents2.default, { app: this, ref: function ref(_ref) {
							_this2.contents = _ref;
						} })
				),
				_react2.default.createElement(
					'div',
					{ id: 'myPage', hidden: 'true' },
...
var Contents = function (_React$Component) {
	...
	function Contents(props) {
		...
		_this.app = props.app;
		_this.moveMyPage = function () {
			_this.app.moveMyPage();
		};
		return _this;
	}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				{ ref: function ref(_ref) {
						return _this2.thumbnameDiv = _ref;
					}, className: className, onClick: this.showDetailModal, onMouseOver: this.onMouseOver, onMouseOut: this.onMouseOut },
				_react2.default.createElement(
					'div',
					{ className: 'caption' },
					_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'h5',
											{ name: 'title', style: { paddingRight: '20px' } },
											_react2.default.createElement(
												'strong',
												null,
												this.props.title
...
var MyPage = function (_React$Component) {
    ...
    function MyPage(props) {
        ...
        _this.app = props.app;
        _this.moveMainView = function () {
            _this.app.moveMainView();
        };
        return _this;
    }
...
var Header = function (_React$Component) {
	...
	function Header(props) {
		...
		_this.moveMainView = props.moveMainView;
		return _this;
	}
	...
	_createClass(State, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'col-sm-6 col-md-6', align: 'right', style: { paddingTop: '30px', paddingRight: '50px' } },
					_react2.default.createElement('img', { src: this.state.image })
				),
				_react2.default.createElement(
					'div',
					{ className: 'col-sm-6 col-md-6', style: { paddingLeft: '30px' } },
					_react2.default.createElement(
						'table',
						{ width: '100%' },
						_react2.default.createElement(
